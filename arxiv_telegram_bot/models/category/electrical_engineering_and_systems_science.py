...
"""
Arxiv Telegram Bot - ElectricalEngineeringAndSystemsScienceCategory
...
class ElectricalEngineeringAndSystemsScienceCategory(dict, Enum):  # type: ignore[misc]
    ...
    def get_code(self) -> str:
        ...
        """
        return f"{ElectricalEngineeringAndSystemsScienceCategory.__cat_name__}.{self.value.get('code')}"
