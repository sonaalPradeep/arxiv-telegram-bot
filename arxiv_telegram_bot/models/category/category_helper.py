...
from arxiv_telegram_bot.models.category.electrical_engineering_and_systems_science import ElectricalEngineeringAndSystemsScience
...
class CategoryHelper:
    ...
    def __init__(self):
        ...
        self.categories_list = ["Computer Science", "Electrical Engineering and Systems Science"]
        self.enum_list = [ComputerScienceCategory, ElectricalEngineeringAndSystemsScience]
